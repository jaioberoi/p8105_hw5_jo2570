...
We see above that as the true value of beta increases, the proportion of times the null was rejected increases showing that as effect size increases the power of the test increases. 
...
We see that the average estimates of beta for values where H0 is rejected are not approximately equal to the true values of beta - the values start quite different, but get closer (more equal) as the true value of beta increases. 
